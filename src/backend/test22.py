...
def send_email_report(user_email, user_name, address, image_path, edge_image_path, severity, severity_description, length, width):
    ...
    try:
        # Email configuration
        sender_email = "homesafe.ai@example.com"  # Replace with your service email
...
# Streamlit UI
#st.set_page_config(page_title="HomeSafe: AI-Powered Housing Inspection", layout="wide")
...
if submit_button and uploaded_file is not None:
    if not email or not name or not address:
        st.error("Please fill in all required fields: Name, Email, and Address.")
    else:
        with col2:
